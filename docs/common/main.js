...
window.run_page = page => { 
	set("page", page);
	import("../" + page + "/page.js").then(o => o.run());
};
...
const start_nothing = _ => {
	window.start_audio = null;	
	window.stop_audio  = stop_nothing;
};

const stop_nothing = _ => {
	window.start_audio  = start_nothing;
